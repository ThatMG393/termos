...
int main()
{
	...
	osFunctions executeFunction;
	osApplications runApplication;
	cout << "**********" << endl;
	cout << "* TermOS *" << endl;
	cout << "**********" << endl;
	cout << version << endl;
	...
	if (program == "-help")
	{
		executeFunction.helpfunc();
	}
	else if (program == "-imgv")
	{
		runApplication.imgvapp();
	}
	else if (program == "-inet")
	{
		runApplication.inetapp();
	}
	else if (program == "-fim")
	{
		runApplication.fimapp();
	}
	else if (program == "-numrandom")
	{
		runApplication.numrandomapp();
	}
	else if (program == "-termpad")
	{
		runApplication.termpadapp();
	}
